...
const TESTNET_MAGIC: [u8; 2] = [84, 60];
...
fn max_msg_size(msg_type: Type) -> u64 {
	match msg_type {
		...
		Type::Header => global::max_header_size_bytes() as u64,
		Type::Headers => (2 + (global::max_header_size_bytes() as u32) * MAX_BLOCK_HEADERS) as u64,
		Type::GetBlock => 32,
